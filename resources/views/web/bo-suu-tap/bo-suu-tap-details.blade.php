@extends('web.index')
@section('title', $detailCollection->name)

@section('content')
    <div id="content" class="site-content" style="padding-top: 30px">
        <div class="container">
            <div id="primary" class="content-sidebar-wrap">
                <h2 class="box-page-title">{{$detailCollection->name ?? ''}}</h2>
                <main id="main" class="site-main" role="main">
                    @include('web.bo-suu-tap.partials.image-slider')
                </main>
                <main id="main" class="site-main" role="main">
                    @include('web.bo-suu-tap.partials.content')
                </main>
            </div><!-- #primary -->
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body text-center">
                    <img id="modalImage" src="{{$detailCollection->src}}" class="img-fluid" alt="Sofa gỗ óc chó tích hợp ngăn để đồ">
                </div>
            </div>
        </div>
    </div>
