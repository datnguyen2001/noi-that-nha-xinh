...
<div class="project-wrap">
    <div class="container">
        <h2 class="heading">
            <a title="Dự án thiết kế" href="{{route('du-an.du-an-thiet-ke')}}">{{$project_category[0]->name ?? ''}}</a>
        </h2>
                                ...
                                <div class="item-post">
                                    <div class="box_post_list_cat_post_1">
                                        ...
                                        <h3 class="entry-title">
                                            <a href="https://goocchohaanh.com/anh-huan-biet-thu-thanh-pho-lao-cai/" title="{{$post_project1->name}}">
                                                {{$post_project1->name}}
                                            </a>
                                       </h3>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="item-product procudr-hot">
                                    <div class="image-product">
                                        <a class="img" href="https://goocchohaanh.com/anh-huan-biet-thu-thanh-pho-lao-cai/" title="{{$post_project1->name}}">
                                            <noscript>
