...
@section('main')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Cập nhật nhận xét</h1>
        </div><!-- End Page Title -->
        <section class="section dashboard">
            <div class="bg-white p-4">
                <form action="{{url("admin/comment/update",$data->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-3">Tên người nhận xét :</div>
                        <div class="col-8">
                            <input class="form-control" name="name_people" value="{{$data->name_people}}" type="text" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-3">Tên nhận xét :</div>
                        <div class="col-8">
                            <input class="form-control" name="name" type="text" value="{{$data->name}}" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-3">Số sao :</div>
                        <div class="col-8">
                            <input class="form-control" name="star" type="number" value="{{$data->star}}" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-8">
                            ...
                            <a href="{{route('admin.comment.index')}}" class="btn btn-danger">Hủy</a>
                        </div>
