            ...
            <div class="bg-white p-4">
                <form action="{{route('admin.comment.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <input class="form-control" name="name_people" type="text" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <input class="form-control" name="star" type="number" required>
                        </div>
                    </div>
                    <div class="row mt-3">
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body mt-2">
                            <textarea name="describe" class="form-control" rows="10" required></textarea>
                        </div>
                    </div>
                    <div class="row mt-3">
