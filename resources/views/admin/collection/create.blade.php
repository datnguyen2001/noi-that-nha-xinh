    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <form action="{{route('admin.collection.store-info')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <textarea class="form-control" name="describe" rows="10" required></textarea>
                        </div>
                    </div>
                    <div class="row mt-3">
