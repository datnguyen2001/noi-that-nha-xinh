                ...
                <div class="modal-content">
                    <form method="POST" action="{{ route('admin.collection.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="add-category-name" class="form-label">Tên bộ sưu tập</label>
    ...
    @foreach ($listData as $key => $cate)
        <!-- Edit category modal -->
            <div class="modal fade" id="editCategory{{ $cate->id }}" data-bs-backdrop="static"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <form method="POST" action="{{ route('admin.collection.update', ['id' => $cate->id]) }}"
                            ...
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="edit-category-name-{{ $cate->id }}" class="form-label">Tên bộ sưu tập</label>
